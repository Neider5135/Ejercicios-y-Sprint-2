    ...
    for (let j = i; j < i + 4; j++) {
        if (data.events[j] != undefined) {
            ...
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item">Stock: ${data.events[j].stock}</li>
            </ul>
            <div class="card-body">
